...
const create = async (executive) => {
    ...
    try {
        ...
        await db.collection('orm1_manager').insertOne({
            "employeeid": executive.id
        })

        await db.collection('orm1_executive').insertOne({
...
const read = async (id) => {
    ...
    try {
        ...
        const collection = client.db("4660-Boiz").collection("orm1_executive")
...
const remove = async (id) => {
    ...
    try {
        ...
        await db.collection("orm1_manager").deleteOne({"employeeid": id})
        await db.collection("orm1_executive").deleteOne({"managerid": id})
