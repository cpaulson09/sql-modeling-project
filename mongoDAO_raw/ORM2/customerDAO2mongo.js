...
const create = async (customer) => {
    ...
    try {
        ...
        await db.collection('orm2_customer').insertOne(customer)
...
const read = async (id) => {
    ...
    try {
        ...
        const collection = client.db("4660-Boiz").collection("orm2_customer")
...
const remove = async (id) => {
    ...
    try {
        ...
        await db.collection("orm2_customer").deleteOne({"id": id})
